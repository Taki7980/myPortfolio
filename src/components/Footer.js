...
function Footer(props) {
    return (
        <>
            <div className="footer px-8 pt-8 pb-[200px] h-[100%]">
                        ...
                        <div className="flex flex-wrap justify-center">
                            <div className="flex justify-center w-full mb-32">
                                <div className="relative">
                                    <img src={props.profilePicture} className="dark:shadow-xl border-white dark:border-gray-800 rounded-full align-middle border-8 absolute -m-16 -ml-18 lg:-ml-16 max-w-[150px]" alt='' />
                                </div>
                            </div>
                        </div>
                        <div className="mt-2  text-center">
                            <h3 className="mb-1 text-2xl font-bold leading-normal text-gray-700 dark:text-gray-300">Nirjhar sarkar</h3>
                            <div className="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd"></path>
                                </svg>

                                <div className="sm:text-sm font-bold tracking-wide text-gray-600 dark:text-gray-300 font-mono text-xl">Web developer</div>
                            ...
                            <div className="w-full text-center">
                                <div className="flex justify-center pt-8 pb-0 lg:pt-4">
                                    <div className="flex space-x-2">
                                        ...
                                        <a className="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary" href="https://github.com/Taki7980" rel="noreferrer" aria-label="nirjhar on Github" target="_blank">
                                        ...
                                        <a
                                            className="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary"
                                            href="https://www.linkedin.com/in/genos-gaming-88878123a/"
                                            rel="noreferrer"
                                            aria-label="Nirjhar on Linkedin"
                                            target="_blank"
                                        >
                                            <svg className="w-6 h-6 overflow-visible fill-current" alt="" aria-hidden="true" viewBox="0 0 140 140">
                                                <path
                                        ...
                                        <a
                                            ...
                                            rel="noreferrer"
                                            aria-label="Nirjhar on Instagram"
                                            target="_blank"
                                        >
                                        ...
                                        <a
                                            className="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary"
                                            href="https://www.youtube.com/channel/UCjfV6VsMHlXkR6CsCsojEdA"
                                            rel="noreferrer"
                                            aria-label="nirjhar on Youtube"
                                            target="_blank"
                                        >
                                            <svg className="w-6 h-6 overflow-visible fill-current" alt="" aria-hidden="true" viewBox="0 0 140 140">
                                                <path
